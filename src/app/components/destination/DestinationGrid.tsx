...
export const DestinationGrid = ({ onSelect }: DestinationGridProps) => {
  return (
    <LayoutGroup>
      <motion.div 
        layout
        className="w-full relative transition-all duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10"
      >
